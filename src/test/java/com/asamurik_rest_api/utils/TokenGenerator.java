...
public class TokenGenerator {
    ...
    public TokenGenerator(String token) throws JSONException {
     ...
     */
    public void doLoginManual() throws JSONException {
        // masukkan credentials user sebagai default untuk proses login
        req.put("username", CredentialsAuth.USERNAME);
        req.put("password", CredentialsAuth.PASSWORD);
...
//            System.out.println(jPath.get("object.nama").toString());
            ...
            if (intResponse != 200 || token == null) {
                System.out.println("USERNAME DAN PASSWORD TIDAK ADA, SISTEM AKAN DIHENTIKAN PROSES NYA");
                System.exit(0);
            }
        } catch (Exception e) {
